...
## Project Structure
    ...
    ├── newport_healthcare_42576  # Django project configurations
...
1. Clone this repo and `cd newport_healthcare_42576`
...
2. Clone this repo and `cd newport_healthcare_42576`
